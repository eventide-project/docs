...
``` sql
SELECT * FROM get_category_messages('someCategory', 0, 1000, correlation => 'someCorrelationCateogry', consumer_group_member => 1, consumer_group_size => 2, condition => 'messages.time >= current_time');
```
